                ...
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="tab-content" id="dental-records-tab">
                        <div class="bg-white rounded-lg shadow-md p-6">
                            ...
                            if ($profile && !empty($profile['medical_history'])): ?>
                                
                                <!-- Medical History Section -->
                                <div class="mb-8">
                                    <h3 class="text-lg font-medium mb-4 text-blue-600 border-b pb-2">Medical History</h3>
                                    <div class="grid grid-cols-1 gap-6">
                                        <div>
                                            <p class="whitespace-pre-line"><?php echo htmlspecialchars($profile['medical_history'] ?? ''); ?></p>
                                        </div>
                                    </div>
                                </div>
                                
                                <?php if (!empty($profile['insurance_info'])): ?>
                                <!-- Insurance Information -->
                                <div class="mb-8">
                                    <h3 class="text-lg font-medium mb-4 text-blue-600 border-b pb-2">Insurance Information</h3>
                                    <div class="grid grid-cols-1 gap-6">
                                        <div>
                                            <p><?php echo htmlspecialchars($profile['insurance_info'] ?? ''); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <?php endif; ?>
                            ...
                            <?php else: ?>
                                <div class="flex flex-col items-center justify-center py-12">
                                    ...
                                    <p class="text-gray-500 mb-4">Edit the patient profile to add dental and medical history.</p>
                                    <a href="edit_patient.php?id=<?php echo $patientId; ?>" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
