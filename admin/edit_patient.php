...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateStmt->bind_param("sssssssi", $firstName, $lastName, $email, $phoneNumber, $gender, $birthdate, $address, $patientId);
    ...
    if ($updateStmt->execute()) {
        ...
        if ($profileResult->num_rows > 0) {
            // Update existing profile with all fields including dental history, medical history, and medical details
            ...
            $updateProfileStmt->bind_param("sssssssssssssssssssssssssiiiiiiiii", 
                $occupation, 
                $emergencyContact, 
                $emergencyPhone, 
                $medicalHistory, 
            ...
            // Create new profile with all fields including dental history, medical history, and medical details
            $createProfileQuery = "INSERT INTO patient_profiles 
                                 (patient_id, occupation, emergency_contact, emergency_phone, medical_history,
                                  nickname, home_number, office_number, fax_number, previous_dentist,
                                  last_dental_visit, reason_for_consultation, referral,
                                  physician_name, physician_specialty, physician_office_address, physician_office_number,
                                  good_health, under_treatment, serious_illness, hospitalized,
                                  prescription_medication, tobacco_use, substance_use,
                                  blood_type, blood_pressure, heart_attack, thyroid_problem, heart_disease, diabetes,
            ...
            $createProfileStmt->bind_param("issssssssssssssssssssssssiiiiiiii", 
                $patientId, 
                $occupation, 
                $emergencyContact, 
                $emergencyPhone, 
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="phone" id="phone" value="<?php echo htmlspecialchars($patient['phone'] ?? ''); ?>" required readonly class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="date" name="dob" id="dob" value="<?php echo htmlspecialchars($patient['dob'] ?? ''); ?>" required readonly class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                    </div>
                                </div>
                            </div>
