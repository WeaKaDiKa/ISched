                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-3 mb-3">
                                    ...
                                    if (!empty($patient['profile_picture'])) {
                                        ...
                                        // Use default avatar
                                        $profilePicture = 'assets/photo/default_avatar.png';
                                    }
                                    ?>
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center">
                                                    ...
                                                    if (!empty($patient['profile_picture'])) {
                                                        // User has a profile picture in the database
                                                        $profilePicture = '../' . $patient['profile_picture'];
                                                        echo '<img src="' . htmlspecialchars($profilePicture) . '" alt="Profile" class="h-10 w-10 rounded-full">';
                                                    } else {
                                                        // Use default avatar
                                                        echo '<img src="../assets/photo/default_avatar.png" alt="Profile" class="h-10 w-10 rounded-full">';
                                                    }
                                                    ?>
                                                </div>
                                                <div class="ml-4">
