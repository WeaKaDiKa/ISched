...
$sql = "SELECT a.id, a.appointment_date, a.appointment_time, a.services,  
...
while ($appointment = $result->fetch_assoc()) {
    ...
    if ($isToday) {
        $notificationMessage = "TODAY {$statusIcon}: {$appointment['first_name']} {$appointment['last_name']} has a {$statusInfo} appointment at {$appointment['appointment_time']}.";        
        $notificationType = "upcoming_appointment_today";
    } else {
        $notificationMessage = "TOMORROW {$statusIcon}: {$appointment['first_name']} {$appointment['last_name']} has a {$statusInfo} appointment at {$appointment['appointment_time']}.";        
