  ...
  <nav class="navbar">
    ...
    <div class="nav-right">
      <a href="<?= $user ? 'bookings.php' : 'login.php' ?>"
         <?= $user ? '' : "onclick=\"showCustomModal('Login Required', 'Please login to book an appointment.', 'login.php'); return false;\"" ?>>
      ...
      <a href="<?= $user ? 'profile.php' : 'login.php' ?>"
         <?= $user ? '' : "onclick=\"showCustomModal('Login Required', 'Please login to view profile.', 'login.php'); return false;\"" ?>>
        <div class="user-icon">
          <?php if ($user): ?>
