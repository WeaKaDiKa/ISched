    ...
    <div class="container">
        ...
        <div class="user-info">
            ...
            <div class="booking-row">
                ...
                <div class="booking-value"><?php echo $userData['first_name'] . ' ' . $userData['last_name']; ?></div>
            </div>
            <div class="booking-row">
                <div class="booking-label">Email:</div>
                <div class="booking-value"><?php echo $userData['email']; ?></div>
            </div>
            <div class="booking-row">
                    ...
                    <div class="booking-card">
                        <div class="booking-header">
                            ...
                            <?php if ($booking['has_been_rescheduled']): ?>
                                <span class="booking-status status-rescheduled">Rescheduled From</span>
                            <?php endif; ?>
                        ...
                        <div class="booking-details">
                            ...
                            <div class="booking-row">
                                ...
                                <div class="booking-value"><?php echo $booking['appointment_time']; ?></div>
                            </div>
                            <div class="booking-row">
                                <div class="booking-label">Branch:</div>
                                <div class="booking-value"><?php echo $booking['clinic_branch']; ?></div>
                            </div>
                            <div class="booking-row">
                                <div class="booking-label">Services:</div>
                                <div class="booking-value"><?php echo $booking['services']; ?></div>
                            </div>
