...
<body class="bg-gray-100">
        ...
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
            ...
            <form id="appointmentForm" class="space-y-4">
                <div>
                    ...
                    <select class="w-full border border-gray-300 rounded-md px-3 py-2" id="patient" name="patient_id" required>
                ...
                <div>
                    ...
                    <select class="w-full border border-gray-300 rounded-md px-3 py-2" id="services" name="services" required>
                ...
                <div>
                    ...
                    <select class="w-full border border-gray-300 rounded-md px-3 py-2" id="appointment_time" name="appointment_time" required>
    ...
    <div id="successModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 hidden transition-opacity duration-300">
      <div class="bg-white rounded-xl shadow-lg p-8 max-w-sm w-full text-center relative transform transition-all duration-300 scale-90 opacity-0">
        ...
        <p class="text-gray-600 mb-6">Appointment created successfully!<br>Reference Number: <span id="successRef" class="font-semibold"></span></p>
