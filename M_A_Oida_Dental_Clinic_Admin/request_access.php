                        ...
                        <table class="min-w-full">
                            <thead>
                                <tr class="bg-gray-50">
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Role Requested</th>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <div class="flex space-x-2">
                                                <form method="POST" class="inline">
                                                    ...
                                                    <button type="submit" class="px-3 py-1.5 bg-green-600 text-white rounded-md hover:bg-green-700">
                                                ...
                                                <form method="POST" class="inline">
                                                    ...
                                                    <button type="submit" class="px-3 py-1.5 bg-red-600 text-white rounded-md hover:bg-red-700">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                </form>
                                                <button class="px-3 py-1.5 bg-blue-600 text-white rounded-md hover:bg-blue-700">
                                                    Details
                                                </button>
                                            </div>
                                        </td>
