...
<body class="bg-gray-100">
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white border-r border-gray-200">
            <div class="p-4">
                <img src="assets/photo/logo.jpg" alt="M&A Oida Dental Clinic" class="w-24 h-24 mx-auto">
                <h1 class="text-xl font-bold text-center mt-2">M&A Oida Dental Clinic</h1>
            </div>
            <nav class="mt-4">
                <a href="dashboard.php" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                    <i class="fas fa-home mr-2"></i> Dashboard
                </a>
                <a href="manage_access_requests.php" class="block px-4 py-2 text-blue-600 bg-blue-50 hover:bg-blue-100">
                    <i class="fas fa-user-plus mr-2"></i> Manage Access Requests
                </a>
                <a href="admin_login.php" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                            ...
                            <div class="request-card p-4 rounded-lg">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">
                                            <i class="fas fa-phone mr-1"></i> <?= htmlspecialchars($request['contact_number']) ?>
                                        </p>
                                        <p class="text-sm text-gray-600">
                                            <i class="fas fa-user-tag mr-1"></i> Role: <?= htmlspecialchars($request['role_requested']) ?>
                                        </p>
